...
*AccountItemsApi* | [**destroyAccountItem**](docs/Api/AccountItemsApi.md#destroyaccountitem) | **DELETE** /account_items/{id} | 勘定科目の削除
...
*BanksApi* | [**getBank**](docs/Api/BanksApi.md#getbank) | **GET** /banks/{id} | 連携サービスの取得
...
*DealsApi* | [**destroyDeal**](docs/Api/DealsApi.md#destroydeal) | **DELETE** /deals/{id} | 取引（収入／支出）の削除
...
*ExpenseApplicationLineTemplatesApi* | [**createExpenseApplicationLineTemplate**](docs/Api/ExpenseApplicationLineTemplatesApi.md#createexpenseapplicationlinetemplate) | **POST** /expense_application_line_templates | 経費科目の作成
*ExpenseApplicationLineTemplatesApi* | [**destroyExpenseApplicationLineTemplate**](docs/Api/ExpenseApplicationLineTemplatesApi.md#destroyexpenseapplicationlinetemplate) | **DELETE** /expense_application_line_templates/{id} | 経費科目の削除
*ExpenseApplicationLineTemplatesApi* | [**getExpenseApplicationLineTemplate**](docs/Api/ExpenseApplicationLineTemplatesApi.md#getexpenseapplicationlinetemplate) | **GET** /expense_application_line_templates/{id} | 経費科目の取得
...
*ExpenseApplicationLineTemplatesApi* | [**updateExpenseApplicationLineTemplate**](docs/Api/ExpenseApplicationLineTemplatesApi.md#updateexpenseapplicationlinetemplate) | **PUT** /expense_application_line_templates/{id} | 経費科目の更新
...
*ExpenseApplicationsApi* | [**getExpenseApplication**](docs/Api/ExpenseApplicationsApi.md#getexpenseapplication) | **GET** /expense_applications/{id} | 経費申請詳細の取得
*ExpenseApplicationsApi* | [**getExpenseApplications**](docs/Api/ExpenseApplicationsApi.md#getexpenseapplications) | **GET** /expense_applications | 経費申請一覧の取得
...
*InvoicesApi* | [**getInvoice**](docs/Api/InvoicesApi.md#getinvoice) | **GET** /invoices/{id} | 請求書の取得
...
*ItemsApi* | [**destroyItem**](docs/Api/ItemsApi.md#destroyitem) | **DELETE** /items/{id} | 品目の削除
*ItemsApi* | [**getItem**](docs/Api/ItemsApi.md#getitem) | **GET** /items/{id} | 品目の取得
*ItemsApi* | [**getItems**](docs/Api/ItemsApi.md#getitems) | **GET** /items | 品目一覧の取得
*ItemsApi* | [**updateItem**](docs/Api/ItemsApi.md#updateitem) | **PUT** /items/{id} | 品目の更新
...
*PartnersApi* | [**destroyPartner**](docs/Api/PartnersApi.md#destroypartner) | **DELETE** /partners/{id} | 取引先の削除
*PartnersApi* | [**getPartner**](docs/Api/PartnersApi.md#getpartner) | **GET** /partners/{id} | 取引先の取得
...
*ReceiptsApi* | [**destroyReceipt**](docs/Api/ReceiptsApi.md#destroyreceipt) | **DELETE** /receipts/{id} | ファイルボックス 証憑ファイルを削除する
*ReceiptsApi* | [**getReceipt**](docs/Api/ReceiptsApi.md#getreceipt) | **GET** /receipts/{id} | ファイルボックス 証憑ファイルの取得
*ReceiptsApi* | [**getReceipts**](docs/Api/ReceiptsApi.md#getreceipts) | **GET** /receipts | ファイルボックス 証憑ファイル一覧の取得
*ReceiptsApi* | [**updateReceipt**](docs/Api/ReceiptsApi.md#updatereceipt) | **PUT** /receipts/{id} | ファイルボックス 証憑ファイル情報更新
...
*TagsApi* | [**destroyTag**](docs/Api/TagsApi.md#destroytag) | **DELETE** /tags/{id} | メモタグの削除
*TagsApi* | [**getTag**](docs/Api/TagsApi.md#gettag) | **GET** /tags/{id} | メモタグの詳細情報の取得
*TagsApi* | [**getTags**](docs/Api/TagsApi.md#gettags) | **GET** /tags | メモタグ一覧の取得
*TagsApi* | [**updateTag**](docs/Api/TagsApi.md#updatetag) | **PUT** /tags/{id} | メモタグの更新
*TaxesApi* | [**getTaxCode**](docs/Api/TaxesApi.md#gettaxcode) | **GET** /taxes/codes/{code} | 税区分コードの取得
...
*TransfersApi* | [**destroyTransfer**](docs/Api/TransfersApi.md#destroytransfer) | **DELETE** /transfers/{id} | 取引（振替）の削除する
*TransfersApi* | [**getTransfer**](docs/Api/TransfersApi.md#gettransfer) | **GET** /transfers/{id} | 取引（振替）の取得
*TransfersApi* | [**getTransfers**](docs/Api/TransfersApi.md#gettransfers) | **GET** /transfers | 取引（振替）一覧の取得
*TransfersApi* | [**updateTransfer**](docs/Api/TransfersApi.md#updatetransfer) | **PUT** /transfers/{id} | 取引（振替）の更新
...
*UsersApi* | [**getUsers**](docs/Api/UsersApi.md#getusers) | **GET** /users | 事業所に所属するユーザー一覧の取得
...
*UsersApi* | [**updateUser**](docs/Api/UsersApi.md#updateuser) | **PUT** /users/me | ユーザー情報の更新
*WalletTxnsApi* | [**createWalletTxn**](docs/Api/WalletTxnsApi.md#createwallettxn) | **POST** /wallet_txns | 明細の作成
*WalletTxnsApi* | [**destroyWalletTxn**](docs/Api/WalletTxnsApi.md#destroywallettxn) | **DELETE** /wallet_txns/{id} | 明細の削除
*WalletTxnsApi* | [**getWalletTxn**](docs/Api/WalletTxnsApi.md#getwallettxn) | **GET** /wallet_txns/{id} | 明細の取得
...
*WalletablesApi* | [**destroyWalletable**](docs/Api/WalletablesApi.md#destroywalletable) | **DELETE** /walletables/{type}/{id} | 口座の削除
*WalletablesApi* | [**getWalletable**](docs/Api/WalletablesApi.md#getwalletable) | **GET** /walletables/{type}/{id} | 口座情報の取得
*WalletablesApi* | [**getWalletables**](docs/Api/WalletablesApi.md#getwalletables) | **GET** /walletables | 口座一覧の取得
*WalletablesApi* | [**updateWalletable**](docs/Api/WalletablesApi.md#updatewalletable) | **PUT** /walletables/{type}/{id} | 口座の更新
