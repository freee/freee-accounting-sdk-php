...
class ApprovalRequestsApi
{
     ...
     */
    protected function createApprovalRequestRequest($approval_request_create_params = null)
    {
        ...
        if (isset($approval_request_create_params)) {
            $_tempBody = $approval_request_create_params;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function destroyApprovalRequestRequest($id, $company_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApprovalRequestRequest($id, $company_id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApprovalRequestFormRequest($id, $company_id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApprovalRequestFormsRequest($company_id)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApprovalRequestsRequest($company_id, $status = null, $application_number = null, $title = null, $form_id = null, $start_application_date = null, $end_application_date = null, $applicant_id = null, $approver_id = null, $offset = null, $limit = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateApprovalRequestRequest($id, $approval_request_update_params)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($approval_request_update_params)) {
            $_tempBody = $approval_request_update_params;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateApprovalRequestActionRequest($id, $approval_request_action_create_params)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($approval_request_action_create_params)) {
            $_tempBody = $approval_request_action_create_params;
        }
