...
class ExpenseApplicationsApi
{
    ...
    protected function getExpenseApplicationsRequest($company_id, $offset = null, $limit = null)
    {
        ...
        if ($offset !== null && $offset > -9223372036854775616) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling ExpenseApplicationsApi.getExpenseApplications, must be smaller than or equal to -9223372036854775616.');
        }
