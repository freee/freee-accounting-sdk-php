...
class ExpenseApplicationsApi
{
            ...
            switch($statusCode) {
                case 201:
                    if ('\Freee\Accounting\Model\ExpenseApplicationResponse' === '\SplFileObject') {
                        ...
                        if ('\Freee\Accounting\Model\ExpenseApplicationResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\ExpenseApplicationsIndexResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\ExpenseApplicationsIndexResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
    ...
    public function getExpenseApplicationsRequest($company_id, $status = null, $payroll_attached = null, $start_transaction_date = null, $end_transaction_date = null, $application_number = null, $title = null, $start_issue_date = null, $end_issue_date = null, $applicant_id = null, $approver_id = null, $min_amount = null, $max_amount = null, $offset = null, $limit = null)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $payroll_attached,
            'payroll_attached', // param base name
            'boolean', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'start_transaction_date', // param base name
            'string', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'end_transaction_date', // param base name
            'string', // openApiType
            'form', // style
            true // explode
        ) ?? []);
     ...
     *
     * @param  int $id 経費申請ID (required)
     * @param  \Freee\Accounting\Model\ExpenseApplicationActionCreateParams $expense_application_action_create_params 経費申請の承認操作 (required)
     *
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Freee\Accounting\Model\ExpenseApplicationResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError|\Freee\Accounting\Model\ForbiddenError|\Freee\Accounting\Model\BadRequestNotFoundError|\Freee\Accounting\Model\InternalServerError
