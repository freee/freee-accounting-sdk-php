...
class RenewsApi
{
     ...
     * @param  \Freee\Accounting\Model\RenewsCreateParams $renews_create_params 取引（収入／支出）に対する+更新の情報 (required)
     *
     ...
     */
    public function createDealRenew($id, $renews_create_params)
    {
        list($response) = $this->createDealRenewWithHttpInfo($id, $renews_create_params);
        return $response;
    }
     ...
     */
    public function createDealRenewWithHttpInfo($id, $renews_create_params)
    {
        $request = $this->createDealRenewRequest($id, $renews_create_params);
     ...
     */
    public function createDealRenewAsync($id, $renews_create_params)
    {
        return $this->createDealRenewAsyncWithHttpInfo($id, $renews_create_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDealRenewAsyncWithHttpInfo($id, $renews_create_params)
    {
        $returnType = '\Freee\Accounting\Model\RenewsResponse';
        $request = $this->createDealRenewRequest($id, $renews_create_params);
     ...
     */
    protected function createDealRenewRequest($id, $renews_create_params)
    {
        ...
        // verify the required parameter 'renews_create_params' is set
        if ($renews_create_params === null || (is_array($renews_create_params) && count($renews_create_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $renews_create_params when calling createDealRenew'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($renews_create_params)) {
            $_tempBody = $renews_create_params;
        }
     ...
     * @param  int $id 取引ID (required)
     * @param  int $renew_id +更新ID (required)
     * @param  \Freee\Accounting\Model\RenewsUpdateParams $renews_update_params +更新の更新情報 (required)
     *
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Freee\Accounting\Model\RenewsResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError
     */
    public function updateDealRenew($id, $renew_id, $renews_update_params)
    {
        list($response) = $this->updateDealRenewWithHttpInfo($id, $renew_id, $renews_update_params);
        return $response;
    }
     ...
     * @return array of \Freee\Accounting\Model\RenewsResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDealRenewWithHttpInfo($id, $renew_id, $renews_update_params)
    {
        $request = $this->updateDealRenewRequest($id, $renew_id, $renews_update_params);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDealRenewAsync($id, $renew_id, $renews_update_params)
    {
        return $this->updateDealRenewAsyncWithHttpInfo($id, $renew_id, $renews_update_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDealRenewAsyncWithHttpInfo($id, $renew_id, $renews_update_params)
    {
        $returnType = '\Freee\Accounting\Model\RenewsResponse';
        $request = $this->updateDealRenewRequest($id, $renew_id, $renews_update_params);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDealRenewRequest($id, $renew_id, $renews_update_params)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // verify the required parameter 'renews_update_params' is set
        if ($renews_update_params === null || (is_array($renews_update_params) && count($renews_update_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $renews_update_params when calling updateDealRenew'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($renews_update_params)) {
            $_tempBody = $renews_update_params;
        }
