...
class RenewsApi
{
     ...
     */
    protected function createDealRenewRequest($id, $renew_create_params)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDealRenewRequest($id, $renew_id, $renew_update_params)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
