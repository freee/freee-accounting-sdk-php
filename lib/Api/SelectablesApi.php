...
class SelectablesApi
{
     ...
     * @return \Freee\Accounting\Model\SelectablesIndexResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError
     */
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Freee\Accounting\Model\SelectablesIndexResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function getFormsSelectablesRequest($company_id, $includes = null)
    {
        ...
        $resourcePath = '/forms/selectables';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
