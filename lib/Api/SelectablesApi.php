...
class SelectablesApi
{
     ...
     * @return \Freee\Accounting\Model\SelectablesIndexResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError|\Freee\Accounting\Model\InternalServerError
     */
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Freee\Accounting\Model\SelectablesIndexResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError|\Freee\Accounting\Model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function getFormsSelectablesRequest($company_id, $includes = null)
    {
        ...
        if ($company_id > 999999999999) {
            throw new \InvalidArgumentException('invalid value for "$company_id" when calling SelectablesApi.getFormsSelectables, must be smaller than or equal to 999999999999.');
        }
        if ($company_id < 1) {
