...
class JournalsApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getJournalStatusRequest($company_id, $id, $visible_tags = null, $start_date = null, $end_date = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getJournalsRequest($download_type, $company_id, $visible_tags = null, $start_date = null, $end_date = null)
    {
