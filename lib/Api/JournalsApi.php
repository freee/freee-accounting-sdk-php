...
class JournalsApi
{
    ...
    protected function downloadJournalRequest($id, $company_id)
    {
        ...
        $resourcePath = '/journals/reports/{id}/download';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/pdf', 'text/csv; charset=sjis; header=present']
            );
        } else {
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Freee\Accounting\Model\JournalsStatusResponse|\Freee\Accounting\Model\UnauthorizedError|\Freee\Accounting\Model\JournalsStatusNotFoundError
     */
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Freee\Accounting\Model\JournalsStatusResponse|\Freee\Accounting\Model\UnauthorizedError|\Freee\Accounting\Model\JournalsStatusNotFoundError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function getJournalStatusRequest($company_id, $id, $visible_tags = null, $start_date = null, $end_date = null)
    {
        ...
        $resourcePath = '/journals/reports/{id}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Freee\Accounting\Model\JournalsEnqueueJournalsResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError
     */
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Freee\Accounting\Model\JournalsEnqueueJournalsResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError, HTTP status code, HTTP response headers (array of strings)
     */
