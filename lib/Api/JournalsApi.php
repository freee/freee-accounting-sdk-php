            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\JournalStatusResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\JournalStatusResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 202:
                    if ('\Freee\Accounting\Model\JournalsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\JournalsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
