...
class DealsApi
{
            ...
            switch($statusCode) {
                case 201:
                    if ('\Freee\Accounting\Model\DealCreateResponse' === '\SplFileObject') {
                        ...
                        if ('\Freee\Accounting\Model\DealCreateResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\InlineResponse2001' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\InlineResponse2001' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
    ...
    public function getDealsRequest($company_id, $partner_id = null, $account_item_id = null, $partner_code = null, $status = null, $type = null, $start_issue_date = null, $end_issue_date = null, $start_due_date = null, $end_due_date = null, $start_renew_date = null, $end_renew_date = null, $offset = null, $limit = null, $registered_from = null, $accruals = null)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $start_renew_date,
            'start_renew_date', // param base name
            'string', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $end_renew_date,
            'end_renew_date', // param base name
            'string', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $registered_from,
            'registered_from', // param base name
            'string', // openApiType
            'form', // style
            true // explode
        ) ?? []);
