...
class DealsApi
{
     ...
     */
    protected function createDealRequest($deal_create_params = null)
    {
    ...
    protected function getDealsRequest($company_id, $partner_id = null, $account_item_id = null, $partner_code = null, $status = null, $type = null, $start_issue_date = null, $end_issue_date = null, $start_due_date = null, $end_due_date = null, $start_renew_date = null, $end_renew_date = null, $offset = null, $limit = null, $registered_from = null, $accruals = null)
    {
        ...
        if ($offset !== null && $offset > -9223372036854775616) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling DealsApi.getDeals, must be smaller than or equal to -9223372036854775616.');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDealRequest($id, $deal_update_params = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
