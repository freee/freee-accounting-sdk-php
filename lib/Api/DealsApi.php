...
class DealsApi
{
     ...
     * 取引（収入／支出）の作成
     *
     * @param  \Freee\Accounting\Model\CreateDealParams $create_deal_params 取引（収入／支出）の作成 (optional)
     *
     ...
     */
    public function createDeal($create_deal_params = null)
    {
        list($response) = $this->createDealWithHttpInfo($create_deal_params);
        return $response;
    }
     ...
     */
    public function createDealWithHttpInfo($create_deal_params = null)
    {
        $request = $this->createDealRequest($create_deal_params);
     ...
     */
    public function createDealAsync($create_deal_params = null)
    {
        return $this->createDealAsyncWithHttpInfo($create_deal_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDealAsyncWithHttpInfo($create_deal_params = null)
    {
        $returnType = '\Freee\Accounting\Model\DealsCreateResponse';
        $request = $this->createDealRequest($create_deal_params);
     ...
     */
    protected function createDealRequest($create_deal_params = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($create_deal_params)) {
            $_tempBody = $create_deal_params;
        }
     ...
     * @param  \Freee\Accounting\Model\UpdateDealParams $update_deal_params 取引（収入／支出）の更新 (optional)
     *
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Freee\Accounting\Model\DealsResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError
     */
    public function updateDeal($id, $update_deal_params = null)
    {
        list($response) = $this->updateDealWithHttpInfo($id, $update_deal_params);
        return $response;
    }
     ...
     * @return array of \Freee\Accounting\Model\DealsResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDealWithHttpInfo($id, $update_deal_params = null)
    {
        $request = $this->updateDealRequest($id, $update_deal_params);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDealAsync($id, $update_deal_params = null)
    {
        return $this->updateDealAsyncWithHttpInfo($id, $update_deal_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDealAsyncWithHttpInfo($id, $update_deal_params = null)
    {
        $returnType = '\Freee\Accounting\Model\DealsResponse';
        $request = $this->updateDealRequest($id, $update_deal_params);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDealRequest($id, $update_deal_params = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($update_deal_params)) {
            $_tempBody = $update_deal_params;
        }
