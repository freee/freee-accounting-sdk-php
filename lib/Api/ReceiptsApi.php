...
class ReceiptsApi
{
     ...
     * @return \Freee\Accounting\Model\ReceiptCreateResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError
     */
     ...
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Freee\Accounting\Model\ReceiptCreateResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createReceiptWithHttpInfo($company_id, $receipt, $description = null, $issue_date = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Freee\Accounting\Model\ReceiptCreateResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Freee\Accounting\Model\ReceiptCreateResponse', []),
            ...
            $returnType = '\Freee\Accounting\Model\ReceiptCreateResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Freee\Accounting\Model\ReceiptCreateResponse',
