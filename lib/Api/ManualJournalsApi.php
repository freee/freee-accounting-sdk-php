...
class ManualJournalsApi
{
            ...
            switch($statusCode) {
                case 201:
                    if ('\Freee\Accounting\Model\ManualJournalResponse' === '\SplFileObject') {
                        ...
                        if ('\Freee\Accounting\Model\ManualJournalResponse' !== 'string') {
                ...
                case 503:
                    if ('\Freee\Accounting\Model\ServiceUnavailableError' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\ServiceUnavailableError' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\InlineResponse2004' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\InlineResponse2004' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
    ...
    public function getManualJournalsRequest($company_id, $start_issue_date = null, $end_issue_date = null, $entry_side = null, $account_item_id = null, $min_amount = null, $max_amount = null, $partner_id = null, $partner_code = null, $item_id = null, $section_id = null, $segment_1_tag_id = null, $segment_2_tag_id = null, $segment_3_tag_id = null, $comment_status = null, $comment_important = null, $adjustment = null, $txn_number = null, $offset = null, $limit = null)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $account_item_id,
            'account_item_id', // param base name
            'integer', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $segment_1_tag_id,
            'segment_1_tag_id', // param base name
            'integer', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $segment_2_tag_id,
            'segment_2_tag_id', // param base name
            'integer', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $segment_3_tag_id,
            'segment_3_tag_id', // param base name
            'integer', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $comment_status,
            'comment_status', // param base name
            'string', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $comment_important,
            'comment_important', // param base name
            'boolean', // openApiType
            'form', // style
            true // explode
        ) ?? []);
