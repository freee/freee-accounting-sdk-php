...
class ManualJournalsApi
{
     ...
     * 振替伝票の作成
     *
     * @param  \Freee\Accounting\Model\ManualJournalsCreateParams $manual_journals_create_params 振替伝票の作成 (optional)
     *
     ...
     */
    public function createManualJournal($manual_journals_create_params = null)
    {
        list($response) = $this->createManualJournalWithHttpInfo($manual_journals_create_params);
        return $response;
    }
     ...
     */
    public function createManualJournalWithHttpInfo($manual_journals_create_params = null)
    {
        $request = $this->createManualJournalRequest($manual_journals_create_params);
     ...
     */
    public function createManualJournalAsync($manual_journals_create_params = null)
    {
        return $this->createManualJournalAsyncWithHttpInfo($manual_journals_create_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createManualJournalAsyncWithHttpInfo($manual_journals_create_params = null)
    {
        $returnType = '\Freee\Accounting\Model\ManualJournalsCreateResponse';
        $request = $this->createManualJournalRequest($manual_journals_create_params);
     ...
     */
    protected function createManualJournalRequest($manual_journals_create_params = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($manual_journals_create_params)) {
            $_tempBody = $manual_journals_create_params;
        }
     ...
     *
     * @param  int $id id (required)
     * @param  \Freee\Accounting\Model\ManualJournalsUpdateParams $manual_journals_update_params 振替伝票の更新 (optional)
     *
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function updateManualJournal($id, $manual_journals_update_params = null)
    {
        list($response) = $this->updateManualJournalWithHttpInfo($id, $manual_journals_update_params);
        return $response;
    }
     ...
     */
    public function updateManualJournalWithHttpInfo($id, $manual_journals_update_params = null)
    {
        $request = $this->updateManualJournalRequest($id, $manual_journals_update_params);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateManualJournalAsync($id, $manual_journals_update_params = null)
    {
        return $this->updateManualJournalAsyncWithHttpInfo($id, $manual_journals_update_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateManualJournalAsyncWithHttpInfo($id, $manual_journals_update_params = null)
    {
        $returnType = '\Freee\Accounting\Model\ManualJournalsUpdateResponse';
        $request = $this->updateManualJournalRequest($id, $manual_journals_update_params);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateManualJournalRequest($id, $manual_journals_update_params = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($manual_journals_update_params)) {
            $_tempBody = $manual_journals_update_params;
        }
