            ...
            switch($statusCode) {
                case 201:
                    if ('\Freee\Accounting\Model\WalletableCreateResponse' === '\SplFileObject') {
                        ...
                        if ('\Freee\Accounting\Model\WalletableCreateResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\InlineResponse20016' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\InlineResponse20016' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\InlineResponse20015' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\InlineResponse20015' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
