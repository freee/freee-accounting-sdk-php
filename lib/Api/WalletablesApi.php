...
class WalletablesApi
{
     ...
     * 口座の作成
     *
     * @param  \Freee\Accounting\Model\CreateWalletableParams $create_walletable_params 口座の作成 (optional)
     *
     ...
     */
    public function createWalletable($create_walletable_params = null)
    {
        list($response) = $this->createWalletableWithHttpInfo($create_walletable_params);
        return $response;
    }
     ...
     */
    public function createWalletableWithHttpInfo($create_walletable_params = null)
    {
        $request = $this->createWalletableRequest($create_walletable_params);
     ...
     */
    public function createWalletableAsync($create_walletable_params = null)
    {
        return $this->createWalletableAsyncWithHttpInfo($create_walletable_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWalletableAsyncWithHttpInfo($create_walletable_params = null)
    {
        $returnType = '\Freee\Accounting\Model\WalletablesCreateResponse';
        $request = $this->createWalletableRequest($create_walletable_params);
     ...
     */
    protected function createWalletableRequest($create_walletable_params = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($create_walletable_params)) {
            $_tempBody = $create_walletable_params;
        }
