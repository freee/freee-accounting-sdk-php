...
class InvoicesApi
{
     ...
     * 請求書の作成
     *
     * @param  \Freee\Accounting\Model\InvoicesCreateParams $invoices_create_params 請求書の作成 (optional)
     *
     ...
     */
    public function createInvoice($invoices_create_params = null)
    {
        list($response) = $this->createInvoiceWithHttpInfo($invoices_create_params);
        return $response;
    }
     ...
     */
    public function createInvoiceWithHttpInfo($invoices_create_params = null)
    {
        $request = $this->createInvoiceRequest($invoices_create_params);
     ...
     */
    public function createInvoiceAsync($invoices_create_params = null)
    {
        return $this->createInvoiceAsyncWithHttpInfo($invoices_create_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInvoiceAsyncWithHttpInfo($invoices_create_params = null)
    {
        $returnType = '\Freee\Accounting\Model\InvoicesResponse';
        $request = $this->createInvoiceRequest($invoices_create_params);
     ...
     */
    protected function createInvoiceRequest($invoices_create_params = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($invoices_create_params)) {
            $_tempBody = $invoices_create_params;
        }
     ...
     * @param  \Freee\Accounting\Model\InvoicesUpdateParams $invoices_update_params 請求書の更新 (optional)
     *
     * @throws \Freee\Accounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Freee\Accounting\Model\InvoicesResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError
     */
    public function updateInvoice($id, $invoices_update_params = null)
    {
        list($response) = $this->updateInvoiceWithHttpInfo($id, $invoices_update_params);
        return $response;
    }
     ...
     * @return array of \Freee\Accounting\Model\InvoicesResponse|\Freee\Accounting\Model\BadRequestError|\Freee\Accounting\Model\UnauthorizedError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateInvoiceWithHttpInfo($id, $invoices_update_params = null)
    {
        $request = $this->updateInvoiceRequest($id, $invoices_update_params);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateInvoiceAsync($id, $invoices_update_params = null)
    {
        return $this->updateInvoiceAsyncWithHttpInfo($id, $invoices_update_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateInvoiceAsyncWithHttpInfo($id, $invoices_update_params = null)
    {
        $returnType = '\Freee\Accounting\Model\InvoicesResponse';
        $request = $this->updateInvoiceRequest($id, $invoices_update_params);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateInvoiceRequest($id, $invoices_update_params = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($invoices_update_params)) {
            $_tempBody = $invoices_update_params;
        }
