...
class QuotationsApi
{
    ...
    protected function getQuotationsRequest($company_id, $partner_id = null, $partner_code = null, $start_issue_date = null, $end_issue_date = null, $quotation_number = null, $description = null, $quotation_status = null, $offset = null, $limit = null)
    {
        ...
        if ($offset !== null && $offset > -9223372036854775616) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling QuotationsApi.getQuotations, must be smaller than or equal to -9223372036854775616.');
        }
