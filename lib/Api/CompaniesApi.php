            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\CompanyIndexResponse' === '\SplFileObject') {
                        ...
                        if ('\Freee\Accounting\Model\CompanyIndexResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Freee\Accounting\Model\CompanyResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Freee\Accounting\Model\CompanyResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
