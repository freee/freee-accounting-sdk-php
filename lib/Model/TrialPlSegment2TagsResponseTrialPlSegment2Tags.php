...
class TrialPlSegment2TagsResponseTrialPlSegment2Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 1.');
        }
