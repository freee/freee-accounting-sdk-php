...
/**
 * TrialPlSegment2TagsResponseTrialPlSegment2Tags Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialPlSegment2TagsResponseTrialPlSegment2Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialPlSegment_2TagsResponse_trial_pl_segment_2_tags';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'balances' => '\Freee\Accounting\Model\TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances[]'
    ];
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setStartMonth($start_month)
    {
        ...
        if (!is_null($start_month) && ($start_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $start_month when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be smaller than or equal to 12.');
        }
        if (!is_null($start_month) && ($start_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_month when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setEndMonth($end_month)
    {
        ...
        if (!is_null($end_month) && ($end_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $end_month when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be smaller than or equal to 12.');
        }
        if (!is_null($end_month) && ($end_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $end_month when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($partner_id) && ($partner_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($item_id) && ($item_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($section_id) && ($section_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialPlSegment2TagsResponseTrialPlSegment2Tags., must be bigger than or equal to 0.');
        }
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances[] $balances balances
     *
     * @return self
     */
