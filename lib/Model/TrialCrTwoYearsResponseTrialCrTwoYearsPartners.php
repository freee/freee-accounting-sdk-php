...
/**
 * TrialCrTwoYearsResponseTrialCrTwoYearsPartners Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialCrTwoYearsResponseTrialCrTwoYearsPartners implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrTwoYearsResponse_trial_cr_two_years_partners';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrTwoYearsResponseTrialCrTwoYearsPartners., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrTwoYearsResponseTrialCrTwoYearsPartners., must be bigger than or equal to 0.');
        }
