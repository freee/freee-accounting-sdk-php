...
/**
 * TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialPlSegment_2TagsResponse_trial_pl_segment_2_tags_balances';
    ...
    protected static $openAPITypes = [
        ...
        'segment_2_tags' => '\Freee\Accounting\Model\TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags[]',
        'total_line' => 'bool'
    ];
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances., must be bigger than or equal to 1.');
        }
     ...
     * Gets segment_2_tags
     *
     * @return \Freee\Accounting\Model\TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags[]|null
     */
     ...
     * Sets segment_2_tags
     *
     * @param \Freee\Accounting\Model\TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags[]|null $segment_2_tags セグメント2タグ
     *
     * @return self
     */
