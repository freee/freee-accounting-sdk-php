...
class Partner implements ModelInterface, ArrayAccess
{
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Partner., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Partner., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressAttributesPrefectureCode($address_attributes_prefecture_code)
    {
        ...
        if (!is_null($address_attributes_prefecture_code) && ($address_attributes_prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $address_attributes_prefecture_code when calling Partner., must be smaller than or equal to 46.');
        }
        if (!is_null($address_attributes_prefecture_code) && ($address_attributes_prefecture_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $address_attributes_prefecture_code when calling Partner., must be bigger than or equal to 0.');
        }
