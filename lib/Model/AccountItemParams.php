 ...
 * @link     https://openapi-generator.tech
 */
class AccountItemParams implements ModelInterface, ArrayAccess
{
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling AccountItemParams., must be smaller than or equal to 999999999999.');
        }
