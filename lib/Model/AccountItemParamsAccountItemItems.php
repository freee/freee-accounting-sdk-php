 ...
 * @link     https://openapi-generator.tech
 */
class AccountItemParamsAccountItemItems implements ModelInterface, ArrayAccess
{
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $id when calling AccountItemParamsAccountItemItems., must be smaller than or equal to 999999999999.');
        }
