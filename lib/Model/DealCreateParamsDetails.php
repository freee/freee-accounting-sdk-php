...
class DealCreateParamsDetails implements ModelInterface, ArrayAccess
{
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling DealCreateParamsDetails., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling DealCreateParamsDetails., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling DealCreateParamsDetails., must be smaller than or equal to 2147483647.');
        }
