...
/**
 * TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialBsTwoYearsResponse_trial_bs_two_years_segment_2_tags';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags., must be bigger than or equal to 1.');
        }
