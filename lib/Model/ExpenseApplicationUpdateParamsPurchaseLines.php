...
/**
 * ExpenseApplicationUpdateParamsPurchaseLines Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseApplicationUpdateParamsPurchaseLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expenseApplicationUpdateParams_purchase_lines';
    ...
    protected static $openAPITypes = [
        'expense_application_lines' => '\Freee\Accounting\Model\ExpenseApplicationUpdateParamsExpenseApplicationLines1[]',
        'id' => 'int',
        'receipt_id' => 'int',
     ...
     *
     * @return \Freee\Accounting\Model\ExpenseApplicationUpdateParamsExpenseApplicationLines1[]|null
     */
     ...
     *
     * @param \Freee\Accounting\Model\ExpenseApplicationUpdateParamsExpenseApplicationLines1[]|null $expense_application_lines 明細行一覧（配列）
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id 経費申請の申請行ID: 既存申請行を更新する場合に指定します。IDを指定しない申請行は、新規行として扱われ追加されます。また、purchase_linesに含まれない既存の申請行は削除されます。更新後も残したい行は、必ず経費申請の申請行IDを指定してpurchase_linesに含めてください。
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationUpdateParamsPurchaseLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($id) && ($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationUpdateParamsPurchaseLines., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiptId($receipt_id)
    {
        ...
        if (!is_null($receipt_id) && ($receipt_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $receipt_id when calling ExpenseApplicationUpdateParamsPurchaseLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($receipt_id) && ($receipt_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $receipt_id when calling ExpenseApplicationUpdateParamsPurchaseLines., must be bigger than or equal to 1.');
        }
