 ...
 * @link     https://openapi-generator.tech
 */
class PartnerCreateParamsPartnerDocSettingAttributes implements ModelInterface, ArrayAccess
{
     ...
     * Sets sending_method
     *
     * @param string|null $sending_method 請求書送付方法(mail:メール、posting:郵送、mail_and_posting:メールと郵送)
     *
     * @return $this
     */
