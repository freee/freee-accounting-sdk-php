...
class DealsRenewsDetails implements ModelInterface, ArrayAccess
{
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling DealsRenewsDetails., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling DealsRenewsDetails., must be smaller than or equal to 999999999999.');
        }
