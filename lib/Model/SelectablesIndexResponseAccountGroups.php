 ...
 * @link     https://openapi-generator.tech
 */
class SelectablesIndexResponseAccountGroups implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['account_structure_id'] = isset($data['account_structure_id']) ? $data['account_structure_id'] : null;
        $this->container['account_category_id'] = isset($data['account_category_id']) ? $data['account_category_id'] : null;
        $this->container['detail_type'] = isset($data['detail_type']) ? $data['detail_type'] : null;
