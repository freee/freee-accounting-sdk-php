 ...
 */
class TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrSegment_1TagsResponse_trial_cr_segment_1_tags_balances';
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances., must be bigger than or equal to 1.');
        }
