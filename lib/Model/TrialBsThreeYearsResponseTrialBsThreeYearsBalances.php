 ...
 */
class TrialBsThreeYearsResponseTrialBsThreeYearsBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sections' => '\Freee\Accounting\Model\TrialBsThreeYearsResponseTrialBsThreeYearsSections[]',
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialBsThreeYearsResponseTrialBsThreeYearsBalances., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialBsThreeYearsResponseTrialBsThreeYearsBalances., must be bigger than or equal to 1.');
        }
     ...
     * Gets sections
     *
     * @return \Freee\Accounting\Model\TrialBsThreeYearsResponseTrialBsThreeYearsSections[]|null
     */
     ...
     * Sets sections
     *
     * @param \Freee\Accounting\Model\TrialBsThreeYearsResponseTrialBsThreeYearsSections[]|null $sections breakdown_display_type:section, account_item_display_type:account_item指定時のみ含まれる
     *
     * @return self
     */
