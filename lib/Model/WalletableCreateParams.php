...
class WalletableCreateParams implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bank_id']) && ($this->container['bank_id'] > 999999999999)) {
            $invalidProperties[] = "invalid value for 'bank_id', must be smaller than or equal to 999999999999.";
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling WalletableCreateParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
    ...
    public function setBankId($bank_id)
    {
        ...
        if (!is_null($bank_id) && ($bank_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $bank_id when calling WalletableCreateParams., must be smaller than or equal to 999999999999.');
        }
