 ...
 * @link     https://openapi-generator.tech
 */
class ApprovalRequestUpdateParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'approvalRequestUpdateParams';
    ...
    public function setApprovalFlowRouteId($approval_flow_route_id)
    {
        ...
        if (($approval_flow_route_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $approval_flow_route_id when calling ApprovalRequestUpdateParams., must be smaller than or equal to 2147483647.');
        }
        if (($approval_flow_route_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $approval_flow_route_id when calling ApprovalRequestUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setApproverId($approver_id)
    {
        ...
        if (!is_null($approver_id) && ($approver_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $approver_id when calling ApprovalRequestUpdateParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($approver_id) && ($approver_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $approver_id when calling ApprovalRequestUpdateParams., must be bigger than or equal to 1.');
        }
