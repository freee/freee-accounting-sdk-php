 ...
 * @link     https://openapi-generator.tech
 */
class DealsRenews implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deals_renews';
    ...
    protected static $openAPITypes = [
        ...
        'details' => '\Freee\Accounting\Model\DealsRenewsDetails[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['renew_target_type'] = isset($data['renew_target_type']) ? $data['renew_target_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['renew_target_type']) && !in_array($this->container['renew_target_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'renew_target_type', must be one of '%s'",
    ...
    public function setId($id)
    {
        ...
        if (($id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DealsRenews., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setRenewTargetId($renew_target_id)
    {
        ...
        if (($renew_target_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $renew_target_id when calling DealsRenews., must be smaller than or equal to 999999999999.');
        }
     ...
     * Gets details
     *
     * @return \Freee\Accounting\Model\DealsRenewsDetails[]
     */
     ...
     * Sets details
     *
     * @param \Freee\Accounting\Model\DealsRenewsDetails[] $details +更新の明細行一覧（配列）
     *
     * @return $this
     */
