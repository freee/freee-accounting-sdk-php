...
class ApprovalRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['approver_id'] = isset($data['approver_id']) ? $data['approver_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['approver_id'] === null) {
            $invalidProperties[] = "'approver_id' can't be null";
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ApprovalRequest., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ApprovalRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets request_items
     *
     * @param \Freee\Accounting\Model\ApprovalRequestRequestItems[] $request_items 各種申請の項目一覧（配列）
     *
     * @return $this
     */
