...
/**
 * DealPayments Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class DealPayments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deal_payments';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling DealPayments., must be smaller than or equal to 9223372036854775807.');
        }
        if (($amount < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling DealPayments., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setFromWalletableId($from_walletable_id)
    {
        ...
        if (!is_null($from_walletable_id) && ($from_walletable_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $from_walletable_id when calling DealPayments., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($from_walletable_id) && ($from_walletable_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $from_walletable_id when calling DealPayments., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DealPayments., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DealPayments., must be bigger than or equal to 1.');
        }
