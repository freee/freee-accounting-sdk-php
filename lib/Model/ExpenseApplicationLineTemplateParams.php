 ...
 * @link     https://openapi-generator.tech
 */
class ExpenseApplicationLineTemplateParams implements ModelInterface, ArrayAccess
{
    ...
    protected static $attributeMap = [
        ...
        'name' => 'name',
        'account_items_id' => 'account_items_id',
        'item_id' => 'item_id',
        'tax_code' => 'tax_code',
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'account_items_id' => 'setAccountItemsId',
        'item_id' => 'setItemId',
        'tax_code' => 'setTaxCode',
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'account_items_id' => 'getAccountItemsId',
        'item_id' => 'getItemId',
        'tax_code' => 'getTaxCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['account_items_id'] = isset($data['account_items_id']) ? $data['account_items_id'] : null;
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ExpenseApplicationLineTemplateParams., must be smaller than or equal to 999999999999.');
        }
    ...
    /**
     * Gets account_items_id
     *
     * @return int|null
     */
    public function getAccountItemsId()
    {
        return $this->container['account_items_id'];
    }

    /**
     * Sets account_items_id
     *
     * @param int|null $account_items_id 勘定科目ID
     *
     * @return $this
     */
    public function setAccountItemsId($account_items_id)
    {
        $this->container['account_items_id'] = $account_items_id;
