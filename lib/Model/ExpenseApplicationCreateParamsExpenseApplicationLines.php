 ...
 * @link     https://openapi-generator.tech
 */
class ExpenseApplicationCreateParamsExpenseApplicationLines implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ExpenseApplicationCreateParamsExpenseApplicationLines., must be smaller than or equal to 1000000000.');
        }
