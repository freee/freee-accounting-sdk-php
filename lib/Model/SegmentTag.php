 ...
 * @link     https://openapi-generator.tech
 */
class SegmentTag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'segmentTag';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shortcut2'] === null) {
            $invalidProperties[] = "'shortcut2' can't be null";
        }
     ...
     * Sets shortcut1
     *
     * @param string $shortcut1 ショートカット１ (20文字以内)
     *
     * @return $this
     */
     ...
     * Sets shortcut2
     *
     * @param string $shortcut2 ショートカット２ (20文字以内)
     *
     * @return $this
     */
