 ...
 * @link     https://openapi-generator.tech
 */
class ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines., must be smaller than or equal to 1000000000.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
