...
/**
 * PartnerCodeParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PartnerCodeParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'partnerCodeParams';
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling PartnerCodeParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling PartnerCodeParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets contact_name
     *
     * @param string|null $contact_name 営業担当者名
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string|null $email 営業担当者 メールアドレス
     *
     * @return $this
     */
