 ...
 */
class TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrSegment_2TagsResponse_trial_cr_segment_2_tags_segment_2_tags';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags., must be bigger than or equal to 0.');
        }
