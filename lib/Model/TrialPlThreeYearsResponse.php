 ...
 */
class TrialPlThreeYearsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['trial_pl_three_years'] = $data['trial_pl_three_years'] ?? null;
