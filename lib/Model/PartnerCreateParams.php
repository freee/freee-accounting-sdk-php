 ...
 */
class PartnerCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'invoice_payment_term_attributes' => '\OpenAPI\Client\Model\PartnerCreateParamsInvoicePaymentTermAttributes',
        'long_name' => 'string',
        'name' => 'string',
        'name_kana' => 'string',
        'org_code' => 'int',
        ...
        'payment_term_attributes' => '\OpenAPI\Client\Model\PartnerCreateParamsPaymentTermAttributes',
        'phone' => 'string',
        'shortcut1' => 'string',
        'shortcut2' => 'string',
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling PartnerCreateParams., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
     ...
     *
     * @return \OpenAPI\Client\Model\PartnerCreateParamsInvoicePaymentTermAttributes|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PartnerCreateParamsInvoicePaymentTermAttributes|null $invoice_payment_term_attributes invoice_payment_term_attributes
     *
     * @return self
     */
    ...
    public function setLongName($long_name)
    {
        if (!is_null($long_name) && (mb_strlen($long_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $long_name when calling PartnerCreateParams., must be smaller than or equal to 255.');
        }
    ...
    public function setNameKana($name_kana)
    {
        if (!is_null($name_kana) && (mb_strlen($name_kana) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name_kana when calling PartnerCreateParams., must be smaller than or equal to 255.');
        }
    ...
    public function setPayerWalletableId($payer_walletable_id)
    {
        ...
        if (!is_null($payer_walletable_id) && ($payer_walletable_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $payer_walletable_id when calling PartnerCreateParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($payer_walletable_id) && ($payer_walletable_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $payer_walletable_id when calling PartnerCreateParams., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\PartnerCreateParamsPaymentTermAttributes|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PartnerCreateParamsPaymentTermAttributes|null $payment_term_attributes payment_term_attributes
     *
     * @return self
     */
