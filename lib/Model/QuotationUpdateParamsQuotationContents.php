...
class QuotationUpdateParamsQuotationContents implements ModelInterface, ArrayAccess
{
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling QuotationUpdateParamsQuotationContents., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling QuotationUpdateParamsQuotationContents., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling QuotationUpdateParamsQuotationContents., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (!is_null($unit_price) && ($unit_price > 9999999999999)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling QuotationUpdateParamsQuotationContents., must be smaller than or equal to 9999999999999.');
        }
        if (!is_null($unit_price) && ($unit_price < -9999999999999)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling QuotationUpdateParamsQuotationContents., must be bigger than or equal to -9999999999999.');
        }
