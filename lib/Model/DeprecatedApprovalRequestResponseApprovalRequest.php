...
/**
 * DeprecatedApprovalRequestResponseApprovalRequest Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DeprecatedApprovalRequestResponseApprovalRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deprecatedApprovalRequestResponse_approval_request';
    ...
    protected static $openAPITypes = [
        ...
        'company_id' => 'int',
        'id' => 'int',
        'request_items' => '\Freee\Accounting\Model\DeprecatedApprovalRequestResponseApprovalRequestRequestItems[]',
        'status' => 'string',
        'title' => 'string'
    ];
    ...
    public function setApplicantId($applicant_id)
    {
        ...
        if (($applicant_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $applicant_id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be smaller than or equal to 2147483647.');
        }
        if (($applicant_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicant_id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets approver_id
     *
     * @param int $approver_id 承認者のユーザーID
     *
     * @return $this
     */
    public function setApproverId($approver_id)
    {
        ...
        if (($approver_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $approver_id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be smaller than or equal to 2147483647.');
        }
        if (($approver_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $approver_id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DeprecatedApprovalRequestResponseApprovalRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets request_items
     *
     * @return \Freee\Accounting\Model\DeprecatedApprovalRequestResponseApprovalRequestRequestItems[]
     */
     ...
     * Sets request_items
     *
     * @param \Freee\Accounting\Model\DeprecatedApprovalRequestResponseApprovalRequestRequestItems[] $request_items 各種申請の項目一覧（配列）
     *
     * @return $this
     */
