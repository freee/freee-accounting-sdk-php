...
class ManualJournalUpdateParamsDetails implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > -9223372036854775616)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ManualJournalUpdateParamsDetails., must be smaller than or equal to -9223372036854775616.');
        }
        if (($amount < 1)) {
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling ManualJournalUpdateParamsDetails., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling ManualJournalUpdateParamsDetails., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling ManualJournalUpdateParamsDetails., must be smaller than or equal to 2147483647.');
        }
