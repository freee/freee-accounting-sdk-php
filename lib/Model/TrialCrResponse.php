 ...
 */
class TrialCrResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrResponse';
    ...
    {
        $this->container['trial_cr'] = $data['trial_cr'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trial_cr'] === null) {
            $invalidProperties[] = "'trial_cr' can't be null";
        }
    ...
    {
        return $this->container['trial_cr'];
    }
     ...
     * @return self
     */
    public function setTrialCr($trial_cr)
    {
        $this->container['trial_cr'] = $trial_cr;
