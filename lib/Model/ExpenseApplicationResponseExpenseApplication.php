...
class ExpenseApplicationResponseExpenseApplication implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets comments
     *
     * @param \Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationComments[] $comments 経費申請のコメント一覧（配列）
     *
     * @return self
     */
     ...
     *
     * @param \Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationApprovalFlowLogs[] $approval_flow_logs 経費申請の承認履歴（配列）
     *
     * @return self
     */
