...
/**
 * ExpenseApplicationActionCreateParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseApplicationActionCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expenseApplicationActionCreateParams';
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ExpenseApplicationActionCreateParams., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ExpenseApplicationActionCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setNextApproverId($next_approver_id)
    {
        ...
        if (!is_null($next_approver_id) && ($next_approver_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $next_approver_id when calling ExpenseApplicationActionCreateParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($next_approver_id) && ($next_approver_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $next_approver_id when calling ExpenseApplicationActionCreateParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets target_round
     *
     * @param int $target_round 対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。経費申請の取得APIレスポンス.current_roundを送信してください。
     *
     * @return self
     */
    public function setTargetRound($target_round)
    {
        ...
        if (($target_round > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $target_round when calling ExpenseApplicationActionCreateParams., must be smaller than or equal to 2147483647.');
        }
        if (($target_round < 0)) {
            throw new \InvalidArgumentException('invalid value for $target_round when calling ExpenseApplicationActionCreateParams., must be bigger than or equal to 0.');
        }
     ...
     * Sets target_step_id
     *
     * @param int $target_step_id 対象承認ステップID 経費申請の取得APIレスポンス.current_step_idを送信してください。
     *
     * @return self
     */
    public function setTargetStepId($target_step_id)
    {
        ...
        if (($target_step_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $target_step_id when calling ExpenseApplicationActionCreateParams., must be smaller than or equal to 2147483647.');
        }
        if (($target_step_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $target_step_id when calling ExpenseApplicationActionCreateParams., must be bigger than or equal to 1.');
        }
