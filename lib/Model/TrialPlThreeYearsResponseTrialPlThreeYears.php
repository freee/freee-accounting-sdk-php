...
/**
 * TrialPlThreeYearsResponseTrialPlThreeYears Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TrialPlThreeYearsResponseTrialPlThreeYears implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialPlThreeYearsResponse_trial_pl_three_years';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'balances' => '\Freee\Accounting\Model\TrialPlThreeYearsResponseTrialPlThreeYearsBalances[]'
    ];
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlThreeYearsResponseTrialPlThreeYears., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlThreeYearsResponseTrialPlThreeYears., must be bigger than or equal to 1.');
        }
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialPlThreeYearsResponseTrialPlThreeYearsBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialPlThreeYearsResponseTrialPlThreeYearsBalances[] $balances balances
     *
     * @return $this
     */
