...
/**
 * TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrThreeYearsResponse_trial_cr_three_years_segment_2_tags';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags., must be bigger than or equal to 0.');
        }
