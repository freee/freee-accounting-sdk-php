 ...
 */
class ExpenseApplicationUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expenseApplicationUpdateParams';
    ...
    public function setApprovalFlowRouteId($approval_flow_route_id)
    {
        ...
        if (!is_null($approval_flow_route_id) && ($approval_flow_route_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $approval_flow_route_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($approval_flow_route_id) && ($approval_flow_route_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $approval_flow_route_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets approver_id
     *
     * @param int|null $approver_id 承認者のユーザーID<br> 指定する承認者のユーザーIDは、申請経路APIを利用して取得してください。
     *
     * @return self
     */
    public function setApproverId($approver_id)
    {
        ...
        if (!is_null($approver_id) && ($approver_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $approver_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($approver_id) && ($approver_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $approver_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 10000.');
        }
     ...
     * Sets draft
     *
     * @param bool|null $draft 経費申請のステータス<br> falseを指定した時は申請中（in_progress）で経費申請を更新します。<br> trueを指定した時は下書き（draft）で経費申請を更新します。<br> 未指定の時は下書きとみなして経費申請を更新します。
     *
     * @return self
     */
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        if ((mb_strlen($title) > 250)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ExpenseApplicationUpdateParams., must be smaller than or equal to 250.');
        }
