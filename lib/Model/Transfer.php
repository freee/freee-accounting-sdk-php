...
class Transfer implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > -9223372036854775616)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Transfer., must be smaller than or equal to -9223372036854775616.');
        }
        if (($amount < 9223372036854775616)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Transfer., must be bigger than or equal to 9223372036854775616.');
        }
