...
/**
 * TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialBsThreeYearsResponse_trial_bs_three_years_segment_1_tags';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags., must be bigger than or equal to 1.');
        }
