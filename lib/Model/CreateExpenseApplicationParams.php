...
/**
 * CreateExpenseApplicationParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateExpenseApplicationParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createExpenseApplicationParams';
    ...
    protected static $openAPITypes = [
        ...
        'section_id' => 'int',
        'tag_ids' => 'int[]',
        'expense_application_lines' => '\Freee\Accounting\Model\CreateExpenseApplicationParamsExpenseApplicationLines[]'
    ];
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling CreateExpenseApplicationParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling CreateExpenseApplicationParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        if ((mb_strlen($title) > 250)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateExpenseApplicationParams., must be smaller than or equal to 250.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateExpenseApplicationParams., must be smaller than or equal to 10000.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling CreateExpenseApplicationParams., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling CreateExpenseApplicationParams., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Freee\Accounting\Model\CreateExpenseApplicationParamsExpenseApplicationLines[]
     */
     ...
     *
     * @param \Freee\Accounting\Model\CreateExpenseApplicationParamsExpenseApplicationLines[] $expense_application_lines expense_application_lines
     *
     * @return $this
     */
