...
/**
 * TrialBsResponseTrialBsSegment2Tags Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialBsResponseTrialBsSegment2Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialBsResponse_trial_bs_segment_2_tags';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsResponseTrialBsSegment2Tags., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsResponseTrialBsSegment2Tags., must be bigger than or equal to 0.');
        }
