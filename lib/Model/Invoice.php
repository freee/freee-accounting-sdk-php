...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Invoice., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
    ...
    public function setCompanyPrefectureCode($company_prefecture_code)
    {
        ...
        if (!is_null($company_prefecture_code) && ($company_prefecture_code < -1)) {
            throw new \InvalidArgumentException('invalid value for $company_prefecture_code when calling Invoice., must be bigger than or equal to -1.');
        }
    ...
    public function setDealId($deal_id)
    {
        ...
        if (!is_null($deal_id) && ($deal_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $deal_id when calling Invoice., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($deal_id) && ($deal_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $deal_id when calling Invoice., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling Invoice., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (($partner_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling Invoice., must be smaller than or equal to 2147483647.');
        }
        if (($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling Invoice., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerPrefectureCode($partner_prefecture_code)
    {
        ...
        if (!is_null($partner_prefecture_code) && ($partner_prefecture_code < -1)) {
            throw new \InvalidArgumentException('invalid value for $partner_prefecture_code when calling Invoice., must be bigger than or equal to -1.');
        }
