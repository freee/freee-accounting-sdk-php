 ...
 */
class TrialBsThreeYearsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['trial_bs_three_years'] = $data['trial_bs_three_years'] ?? null;
