...
/**
 * TrialPlSectionsResponseTrialPlSections Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TrialPlSectionsResponseTrialPlSections implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialPlSectionsResponse_trial_pl_sections';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'balances' => '\Freee\Accounting\Model\TrialPlSectionsResponseTrialPlSectionsBalances[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['section_ids'] = isset($data['section_ids']) ? $data['section_ids'] : null;
        ...
        $this->container['cost_allocation'] = isset($data['cost_allocation']) ? $data['cost_allocation'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cost_allocation']) && !in_array($this->container['cost_allocation'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'cost_allocation', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlSectionsResponseTrialPlSections., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlSectionsResponseTrialPlSections., must be bigger than or equal to 1.');
        }
     ...
     * Sets section_ids
     *
     * @param string $section_ids 出力する部門の指定
     *
     * @return $this
     */
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialPlSectionsResponseTrialPlSectionsBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialPlSectionsResponseTrialPlSectionsBalances[] $balances balances
     *
     * @return $this
     */
