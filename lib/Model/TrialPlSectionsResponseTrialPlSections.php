 ...
 */
class TrialPlSectionsResponseTrialPlSections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['section_ids'] = $data['section_ids'] ?? null;
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlSectionsResponseTrialPlSections., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
    ...
    public function setStartMonth($start_month)
    {
        ...
        if (!is_null($start_month) && ($start_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $start_month when calling TrialPlSectionsResponseTrialPlSections., must be smaller than or equal to 12.');
        }
        if (!is_null($start_month) && ($start_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_month when calling TrialPlSectionsResponseTrialPlSections., must be bigger than or equal to 1.');
        }
    ...
    public function setEndMonth($end_month)
    {
        ...
        if (!is_null($end_month) && ($end_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $end_month when calling TrialPlSectionsResponseTrialPlSections., must be smaller than or equal to 12.');
        }
        if (!is_null($end_month) && ($end_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $end_month when calling TrialPlSectionsResponseTrialPlSections., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $breakdown_display_type 内訳の表示（取引先: partner, 品目: item, 勘定科目: account_item, セグメント1(法人向けプロフェッショナル, 法人向けエンタープライズプラン): segment_1_tag, セグメント2(法人向け エンタープライズプラン):segment_2_tag, セグメント3(法人向け エンタープライズプラン): segment_3_tag）(条件に指定した時のみ含まれる）
     *
     * @return self
     */
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSectionsResponseTrialPlSections., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($partner_id) && ($partner_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSectionsResponseTrialPlSections., must be bigger than or equal to 0.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSectionsResponseTrialPlSections., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($item_id) && ($item_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSectionsResponseTrialPlSections., must be bigger than or equal to 0.');
        }
