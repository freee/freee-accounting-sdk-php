...
class TrialPlSegment1TagsResponseTrialPlSegment1Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSegment1TagsResponseTrialPlSegment1Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSegment1TagsResponseTrialPlSegment1Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialPlSegment1TagsResponseTrialPlSegment1Tags., must be bigger than or equal to 0.');
        }
