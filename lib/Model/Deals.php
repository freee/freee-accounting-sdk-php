...
class Deals implements ModelInterface, ArrayAccess
{
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Deals., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Deals., must be bigger than or equal to 1.');
        }
     ...
     * Gets receipts
     *
     * @return \Freee\Accounting\Model\Receipt[]|null
     */
     ...
     * Sets receipts
     *
     * @param \Freee\Accounting\Model\Receipt[]|null $receipts 証憑ファイル
     *
     * @return $this
     */
