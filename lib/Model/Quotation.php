...
class Quotation implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'quotation_contents' => '\Freee\Accounting\Model\QuotationQuotationContents[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['quotation_contents'] = isset($data['quotation_contents']) ? $data['quotation_contents'] : null;
        $this->container['quotation_layout'] = isset($data['quotation_layout']) ? $data['quotation_layout'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quotation_layout']) && !in_array($this->container['quotation_layout'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'quotation_layout', must be one of '%s'",
        ...
        if (!is_null($this->container['quotation_status']) && !in_array($this->container['quotation_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'quotation_status', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Quotation., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling Quotation., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling Quotation., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling Quotation., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Freee\Accounting\Model\QuotationQuotationContents[]|null
     */
     ...
     *
     * @param \Freee\Accounting\Model\QuotationQuotationContents[]|null $quotation_contents 見積内容
     *
     * @return $this
     */
