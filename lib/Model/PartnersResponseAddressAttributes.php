 ...
 * @link     https://openapi-generator.tech
 */
class PartnersResponseAddressAttributes implements ModelInterface, ArrayAccess
{
    ...
    public function setPrefectureCode($prefecture_code)
    {
        ...
        if (!is_null($prefecture_code) && ($prefecture_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $prefecture_code when calling PartnersResponseAddressAttributes., must be bigger than or equal to 0.');
        }
