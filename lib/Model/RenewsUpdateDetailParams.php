...
/**
 * RenewsUpdateDetailParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RenewsUpdateDetailParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'renewsUpdateDetailParams';
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (($account_item_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
        if (($amount < -999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling RenewsUpdateDetailParams., must be bigger than or equal to -999999999999.');
        }
    ...
    public function setVat($vat)
    {
        ...
        if (!is_null($vat) && ($vat > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($vat) && ($vat < -999999999999)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling RenewsUpdateDetailParams., must be bigger than or equal to -999999999999.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling RenewsUpdateDetailParams., must be bigger than or equal to 0.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling RenewsUpdateDetailParams., must be bigger than or equal to 0.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling RenewsUpdateDetailParams., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling RenewsUpdateDetailParams., must be bigger than or equal to 0.');
        }
