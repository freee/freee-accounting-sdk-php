...
class TrialBsTwoYearsResponseTrialBsTwoYearsSegment3Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsTwoYearsResponseTrialBsTwoYearsSegment3Tags., must be bigger than or equal to 1.');
        }
