 ...
 * @link     https://openapi-generator.tech
 */
class RenewCreateParams implements ModelInterface, ArrayAccess
{
    ...
    public function setRenewTargetId($renew_target_id)
    {
        ...
        if (($renew_target_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $renew_target_id when calling RenewCreateParams., must be smaller than or equal to 2147483647.');
        }
