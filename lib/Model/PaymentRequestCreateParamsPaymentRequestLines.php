...
class PaymentRequestCreateParamsPaymentRequestLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaymentRequestCreateParamsPaymentRequestLines., must be smaller than or equal to 2147483647.');
        }
        if (($amount < 0)) {
