...
/**
 * ExpenseApplicationResponseExpenseApplicationPurchaseLines Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseApplicationResponseExpenseApplicationPurchaseLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expenseApplicationResponse_expense_application_purchase_lines';
    ...
    protected static $openAPITypes = [
        'expense_application_lines' => '\Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1[]',
        'id' => 'int',
        'receipt_id' => 'int',
     ...
     *
     * @return \Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1[]|null
     */
     ...
     *
     * @param \Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1[]|null $expense_application_lines 明細行一覧（配列）
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationResponseExpenseApplicationPurchaseLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationResponseExpenseApplicationPurchaseLines., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiptId($receipt_id)
    {
        ...
        if (!is_null($receipt_id) && ($receipt_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $receipt_id when calling ExpenseApplicationResponseExpenseApplicationPurchaseLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($receipt_id) && ($receipt_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $receipt_id when calling ExpenseApplicationResponseExpenseApplicationPurchaseLines., must be bigger than or equal to 1.');
        }
