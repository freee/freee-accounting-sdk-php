...
/**
 * AccountItemsIndexResponseAccountItems Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountItemsIndexResponseAccountItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'accountItemsIndexResponse_account_items';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['default_tax_id'] = isset($data['default_tax_id']) ? $data['default_tax_id'] : null;
        $this->container['default_tax_code'] = isset($data['default_tax_code']) ? $data['default_tax_code'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['default_tax_id']) && ($this->container['default_tax_id'] > 999999999999)) {
            $invalidProperties[] = "invalid value for 'default_tax_id', must be smaller than or equal to 999999999999.";
        }

        if ($this->container['default_tax_code'] === null) {
            $invalidProperties[] = "'default_tax_code' can't be null";
        }
        if (($this->container['default_tax_code'] > 999999999999)) {
            $invalidProperties[] = "invalid value for 'default_tax_code', must be smaller than or equal to 999999999999.";
        }
    ...
    public function setDefaultTaxId($default_tax_id)
    {
        ...
        if (!is_null($default_tax_id) && ($default_tax_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $default_tax_id when calling AccountItemsIndexResponseAccountItems., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setDefaultTaxCode($default_tax_code)
    {
        ...
        if (($default_tax_code > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $default_tax_code when calling AccountItemsIndexResponseAccountItems., must be smaller than or equal to 999999999999.');
        }
