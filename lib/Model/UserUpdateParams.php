...
class UserUpdateParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userUpdateParams';
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling UserUpdateParams., must be smaller than or equal to 20.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserUpdateParams., must be smaller than or equal to 20.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserUpdateParams., must be smaller than or equal to 20.');
        }
    ...
    public function setFirstNameKana($first_name_kana)
    {
        if (!is_null($first_name_kana) && (mb_strlen($first_name_kana) > 20)) {
            throw new \InvalidArgumentException('invalid length for $first_name_kana when calling UserUpdateParams., must be smaller than or equal to 20.');
        }
    ...
    public function setLastNameKana($last_name_kana)
    {
        if (!is_null($last_name_kana) && (mb_strlen($last_name_kana) > 20)) {
            throw new \InvalidArgumentException('invalid length for $last_name_kana when calling UserUpdateParams., must be smaller than or equal to 20.');
        }
