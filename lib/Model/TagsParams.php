 ...
 * @link     https://openapi-generator.tech
 */
class TagsParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tagsParams';
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TagsParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TagsParams., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagsParams., must be smaller than or equal to 30.');
        }
     ...
     * Sets shortcut1
     *
     * @param string|null $shortcut1 メモタグ検索用 (20文字以内)
     *
     * @return $this
     */
    public function setShortcut1($shortcut1)
    {
        if (!is_null($shortcut1) && (mb_strlen($shortcut1) > 20)) {
            throw new \InvalidArgumentException('invalid length for $shortcut1 when calling TagsParams., must be smaller than or equal to 20.');
        }
     ...
     * Sets shortcut2
     *
     * @param string|null $shortcut2 メモタグ検索用 (20文字以内)
     *
     * @return $this
     */
    public function setShortcut2($shortcut2)
    {
        if (!is_null($shortcut2) && (mb_strlen($shortcut2) > 20)) {
            throw new \InvalidArgumentException('invalid length for $shortcut2 when calling TagsParams., must be smaller than or equal to 20.');
        }
