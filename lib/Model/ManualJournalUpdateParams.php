...
class ManualJournalUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'adjustment' => 'bool',
        'company_id' => 'int',
        'details' => '\OpenAPI\Client\Model\ManualJournalUpdateParamsDetails[]',
        'issue_date' => 'string',
        'receipt_ids' => 'int[]'
    ];
     ...
     * Gets details
     *
     * @return \OpenAPI\Client\Model\ManualJournalUpdateParamsDetails[]
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\ManualJournalUpdateParamsDetails[] $details details
     *
     * @return self
     */
