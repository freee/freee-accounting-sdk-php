...
/**
 * TrialCrSegment3TagsResponseTrialCrSegment3Tags Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialCrSegment3TagsResponseTrialCrSegment3Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrSegment_3TagsResponse_trial_cr_segment_3_tags';
    ...
    protected static $openAPITypes = [
        ...
        'balances' => '\Freee\Accounting\Model\TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances[]',
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances[] $balances balances
     *
     * @return self
     */
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setEndMonth($end_month)
    {
        ...
        if (!is_null($end_month) && ($end_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $end_month when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be smaller than or equal to 12.');
        }
        if (!is_null($end_month) && ($end_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $end_month when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($item_id) && ($item_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($partner_id) && ($partner_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($section_id) && ($section_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be bigger than or equal to 0.');
        }
    ...
    public function setStartMonth($start_month)
    {
        ...
        if (!is_null($start_month) && ($start_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $start_month when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be smaller than or equal to 12.');
        }
        if (!is_null($start_month) && ($start_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_month when calling TrialCrSegment3TagsResponseTrialCrSegment3Tags., must be bigger than or equal to 1.');
        }
