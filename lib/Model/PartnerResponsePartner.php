 ...
 * @link     https://openapi-generator.tech
 */
class PartnerResponsePartner implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoice_payment_term_attributes_additional_months'] = isset($data['invoice_payment_term_attributes_additional_months']) ? $data['invoice_payment_term_attributes_additional_months'] : null;
        $this->container['invoice_payment_term_attributes_cutoff_day'] = isset($data['invoice_payment_term_attributes_cutoff_day']) ? $data['invoice_payment_term_attributes_cutoff_day'] : null;
        $this->container['invoice_payment_term_attributes_fixed_day'] = isset($data['invoice_payment_term_attributes_fixed_day']) ? $data['invoice_payment_term_attributes_fixed_day'] : null;
        ...
        $this->container['payment_term_attributes_additional_months'] = isset($data['payment_term_attributes_additional_months']) ? $data['payment_term_attributes_additional_months'] : null;
        $this->container['payment_term_attributes_cutoff_day'] = isset($data['payment_term_attributes_cutoff_day']) ? $data['payment_term_attributes_cutoff_day'] : null;
        $this->container['payment_term_attributes_fixed_day'] = isset($data['payment_term_attributes_fixed_day']) ? $data['payment_term_attributes_fixed_day'] : null;
