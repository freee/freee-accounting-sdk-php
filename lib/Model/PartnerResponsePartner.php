...
class PartnerResponsePartner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'partner_bank_account_attributes' => '\Freee\Accounting\Model\PartnersResponsePartnerBankAccountAttributes',
    ...
    public function setShortcut1($shortcut1)
    {
        if (!is_null($shortcut1) && (mb_strlen($shortcut1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shortcut1 when calling PartnerResponsePartner., must be smaller than or equal to 255.');
        }
    ...
    public function setShortcut2($shortcut2)
    {
        if (!is_null($shortcut2) && (mb_strlen($shortcut2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shortcut2 when calling PartnerResponsePartner., must be smaller than or equal to 255.');
        }
     ...
     *
     * @return \Freee\Accounting\Model\PartnersResponsePartnerBankAccountAttributes|null
     */
     ...
     *
     * @param \Freee\Accounting\Model\PartnersResponsePartnerBankAccountAttributes|null $partner_bank_account_attributes partner_bank_account_attributes
     *
     * @return self
     */
