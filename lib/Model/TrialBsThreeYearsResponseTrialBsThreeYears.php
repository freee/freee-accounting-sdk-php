 ...
 * @link     https://openapi-generator.tech
 */
class TrialBsThreeYearsResponseTrialBsThreeYears implements ModelInterface, ArrayAccess
{
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialBsThreeYearsResponseTrialBsThreeYears., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
