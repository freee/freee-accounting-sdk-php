...
class CompaniesShowResponseCompany implements ModelInterface, ArrayAccess
{
    ...
    public function setHeadCount($head_count)
    {
        ...
        if (($head_count > 7)) {
            throw new \InvalidArgumentException('invalid value for $head_count when calling CompaniesShowResponseCompany., must be smaller than or equal to 7.');
        }
        if (($head_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_count when calling CompaniesShowResponseCompany., must be bigger than or equal to 0.');
        }
