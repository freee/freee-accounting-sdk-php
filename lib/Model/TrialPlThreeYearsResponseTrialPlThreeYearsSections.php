...
class TrialPlThreeYearsResponseTrialPlThreeYearsSections implements ModelInterface, ArrayAccess
{
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialPlThreeYearsResponseTrialPlThreeYearsSections., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialPlThreeYearsResponseTrialPlThreeYearsSections., must be bigger than or equal to 1.');
        }
