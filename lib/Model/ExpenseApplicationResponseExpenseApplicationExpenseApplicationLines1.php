...
/**
 * ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1 Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expenseApplicationResponse_expense_application_expense_application_lines_1';
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1., must be bigger than or equal to 0.');
        }
    ...
    public function setExpenseApplicationLineTemplateId($expense_application_line_template_id)
    {
        ...
        if (!is_null($expense_application_line_template_id) && ($expense_application_line_template_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $expense_application_line_template_id when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($expense_application_line_template_id) && ($expense_application_line_template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $expense_application_line_template_id when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines1., must be bigger than or equal to 1.');
        }
