...
/**
 * JournalsEnqueueJournalsResponseJournals Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class JournalsEnqueueJournalsResponseJournals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'journalsEnqueueJournalsResponse_journals';
     ...
     * Sets messages
     *
     * @param string|null $messages 受け付けメッセージ
     *
     * @return $this
     */
