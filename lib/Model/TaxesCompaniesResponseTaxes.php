...
/**
 * TaxesCompaniesResponseTaxes Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TaxesCompaniesResponseTaxes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'taxesCompaniesResponse_taxes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['name_ja'] = isset($data['name_ja']) ? $data['name_ja'] : null;
        $this->container['display_category'] = isset($data['display_category']) ? $data['display_category'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['display_category']) && !in_array($this->container['display_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'display_category', must be one of '%s'",
