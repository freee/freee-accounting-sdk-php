 ...
 * @link     https://openapi-generator.tech
 */
class DealRenews implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['renew_target_id'] > 2147483647)) {
            $invalidProperties[] = "invalid value for 'renew_target_id', must be smaller than or equal to 2147483647.";
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DealRenews., must be smaller than or equal to 2147483647.');
        }
        if (($id < 1)) {
    ...
    public function setRenewTargetId($renew_target_id)
    {
        ...
        if (($renew_target_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $renew_target_id when calling DealRenews., must be smaller than or equal to 2147483647.');
        }
