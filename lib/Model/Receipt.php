...
class Receipt implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'file_src' => 'string',
        'user' => '\Freee\Accounting\Model\ReceiptUser'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['file_src'] = isset($data['file_src']) ? $data['file_src'] : null;
     ...
     * Gets user
     *
     * @return \Freee\Accounting\Model\ReceiptUser
     */
     ...
     * Sets user
     *
     * @param \Freee\Accounting\Model\ReceiptUser $user user
     *
     * @return $this
     */
