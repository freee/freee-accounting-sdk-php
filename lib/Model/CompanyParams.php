...
/**
 * CompanyParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class CompanyParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'companyParams';
    ...
    protected static $openAPITypes = [
        ...
        'fax' => 'string',
        'fiscal_years' => '\Freee\Accounting\Model\CompanyParamsFiscalYears',
        'head_count' => 'float',
    ...
    const HEAD_COUNT_0 = 0;
    const HEAD_COUNT_1 = 1;
    const HEAD_COUNT_2 = 2;
    const HEAD_COUNT_3 = 3;
    const HEAD_COUNT_13 = 13;
    const HEAD_COUNT_14 = 14;
    const HEAD_COUNT_15 = 15;
    const HEAD_COUNT_18 = 18;
    const HEAD_COUNT_16 = 16;
    const HEAD_COUNT_17 = 17;
     ...
     * @return string[]
     */
    public function getHeadCountAllowableValues()
    {
        return [
            self::HEAD_COUNT_0,
            self::HEAD_COUNT_1,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getHeadCountAllowableValues();
        if (!is_null($this->container['head_count']) && !in_array($this->container['head_count'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'head_count', must be one of '%s'",
                $this->container['head_count'],
        ...
        if (!is_null($this->container['name_kana']) && (mb_strlen($this->container['name_kana']) > 100)) {
     ...
     *
     * @param int|null $amount_fraction 金額端数処理方法（0: 切り捨て、1: 切り上げ, 2: 四捨五入）
     *
     * @return self
     */
    public function setAmountFraction($amount_fraction)
    {
        ...
        if (!is_null($amount_fraction) && ($amount_fraction > 2)) {
            throw new \InvalidArgumentException('invalid value for $amount_fraction when calling CompanyParams., must be smaller than or equal to 2.');
        }
        if (!is_null($amount_fraction) && ($amount_fraction < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount_fraction when calling CompanyParams., must be bigger than or equal to 0.');
        }
     ...
     * Sets contact_name
     *
     * @param string|null $contact_name 担当者名 (50文字以内)
     *
     * @return self
     */
    public function setContactName($contact_name)
    {
        if (!is_null($contact_name) && (mb_strlen($contact_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling CompanyParams., must be smaller than or equal to 50.');
        }
    ...
    public function setDefaultWalletAccountId($default_wallet_account_id)
    {
        ...
        if (!is_null($default_wallet_account_id) && ($default_wallet_account_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $default_wallet_account_id when calling CompanyParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($default_wallet_account_id) && ($default_wallet_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $default_wallet_account_id when calling CompanyParams., must be bigger than or equal to 1.');
        }
     ...
     * Gets fiscal_years
     *
     * @return \Freee\Accounting\Model\CompanyParamsFiscalYears|null
     */
     ...
     * Sets fiscal_years
     *
     * @param \Freee\Accounting\Model\CompanyParamsFiscalYears|null $fiscal_years fiscal_years
     *
     * @return self
     */
     ...
     * Sets head_count
     *
     * @param float|null $head_count 従業員数（0: 経営者のみ、1: 2~5人、2: 6~10人、3: 11~20人、13: 21~50人、14: 51~100人、15: 101~300人、18: 301~500人、16: 501~1,000人、17: 1,001人以上
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getHeadCountAllowableValues();
        if (!is_null($head_count) && !in_array($head_count, $allowedValues, true)) {
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CompanyParams., must be smaller than or equal to 100.');
        }
    ...
    {
        if (!is_null($name_kana) && (mb_strlen($name_kana) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name_kana when calling CompanyParams., must be smaller than or equal to 100.');
        }
    ...
    public function setPrefectureCode($prefecture_code)
    {
        ...
        if (!is_null($prefecture_code) && ($prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $prefecture_code when calling CompanyParams., must be smaller than or equal to 46.');
        }
        if (!is_null($prefecture_code) && ($prefecture_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $prefecture_code when calling CompanyParams., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param bool|null $private_settlement プライベート資金/役員資金（false: 使用しない、true: 使用する）
     *
     * @return self
     */
     ...
     *
     * @param string|null $txn_number_format 仕訳番号形式（not_used: 使用しない、digits: 数字（例：5091824）、alnum: 英数字（例：59J0P））
     *
     * @return self
     */
