...
class PaymentRequestResponsePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets comments
     *
     * @param \Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationComments[] $comments 支払依頼のコメント一覧（配列）
     *
     * @return self
     */
     ...
     *
     * @param \Freee\Accounting\Model\ExpenseApplicationResponseExpenseApplicationApprovalFlowLogs[] $approval_flow_logs 支払依頼の承認履歴（配列）
     *
     * @return self
     */
