...
/**
 * CreateDealParamsPayments Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateDealParamsPayments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createDealParams_payments';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateDealParamsPayments., must be smaller than or equal to 999999999999.');
        }
        if (($amount < -999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateDealParamsPayments., must be bigger than or equal to -999999999999.');
        }
    ...
    public function setFromWalletableId($from_walletable_id)
    {
        ...
        if (($from_walletable_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $from_walletable_id when calling CreateDealParamsPayments., must be smaller than or equal to 999999999999.');
        }
        if (($from_walletable_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $from_walletable_id when calling CreateDealParamsPayments., must be bigger than or equal to 1.');
        }
