...
/**
 * UpdateExpenseApplicationParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class UpdateExpenseApplicationParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateExpenseApplicationParams';
    ...
    protected static $openAPITypes = [
        ...
        'section_id' => 'int',
        'tag_ids' => 'int[]',
        'expense_application_lines' => '\Freee\Accounting\Model\UpdateExpenseApplicationParamsExpenseApplicationLines[]'
    ];
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling UpdateExpenseApplicationParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling UpdateExpenseApplicationParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        if ((mb_strlen($title) > 250)) {
            throw new \InvalidArgumentException('invalid length for $title when calling UpdateExpenseApplicationParams., must be smaller than or equal to 250.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateExpenseApplicationParams., must be smaller than or equal to 10000.');
        }
     ...
     *
     * @param bool|null $editable_on_web 会計freeeのWeb画面から申請内容を編集可能：falseの場合、Web上からの項目行の追加／削除・金額の編集が出来なくなります。APIでの編集は可能です。
     *
     * @return $this
     */
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling UpdateExpenseApplicationParams., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling UpdateExpenseApplicationParams., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Freee\Accounting\Model\UpdateExpenseApplicationParamsExpenseApplicationLines[]
     */
     ...
     *
     * @param \Freee\Accounting\Model\UpdateExpenseApplicationParamsExpenseApplicationLines[] $expense_application_lines expense_application_lines
     *
     * @return $this
     */
