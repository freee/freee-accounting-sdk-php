...
/**
 * PartnerCreateParamsInvoicePaymentTermAttributes Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PartnerCreateParamsInvoicePaymentTermAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'partnerCreateParams_invoice_payment_term_attributes';
    ...
    {
        $this->container['additional_months'] = isset($data['additional_months']) ? $data['additional_months'] : null;
        $this->container['cutoff_day'] = isset($data['cutoff_day']) ? $data['cutoff_day'] : null;
        $this->container['fixed_day'] = isset($data['fixed_day']) ? $data['fixed_day'] : null;
    }
    ...
    public function setCutoffDay($cutoff_day)
    {
        ...
        if (!is_null($cutoff_day) && ($cutoff_day > 32)) {
            throw new \InvalidArgumentException('invalid value for $cutoff_day when calling PartnerCreateParamsInvoicePaymentTermAttributes., must be smaller than or equal to 32.');
        }
        if (!is_null($cutoff_day) && ($cutoff_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $cutoff_day when calling PartnerCreateParamsInvoicePaymentTermAttributes., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedDay($fixed_day)
    {
        ...
        if (!is_null($fixed_day) && ($fixed_day > 32)) {
            throw new \InvalidArgumentException('invalid value for $fixed_day when calling PartnerCreateParamsInvoicePaymentTermAttributes., must be smaller than or equal to 32.');
        }
        if (!is_null($fixed_day) && ($fixed_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_day when calling PartnerCreateParamsInvoicePaymentTermAttributes., must be bigger than or equal to 1.');
        }
