 ...
 */
class PartnerCreateParamsInvoicePaymentTermAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAdditionalMonths($additional_months)
    {
        ...
        if (!is_null($additional_months) && ($additional_months < 0)) {
            throw new \InvalidArgumentException('invalid value for $additional_months when calling PartnerCreateParamsInvoicePaymentTermAttributes., must be bigger than or equal to 0.');
        }
