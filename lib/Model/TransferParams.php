 ...
 * @link     https://openapi-generator.tech
 */
class TransferParams implements ModelInterface, ArrayAccess
{
    ...
    public function setToWalletableId($to_walletable_id)
    {
        ...
        if (($to_walletable_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $to_walletable_id when calling TransferParams., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setFromWalletableId($from_walletable_id)
    {
        ...
        if (($from_walletable_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $from_walletable_id when calling TransferParams., must be smaller than or equal to 999999999999.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling TransferParams., must be smaller than or equal to 999999999999.');
        }
        if (($amount < -999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling TransferParams., must be bigger than or equal to -999999999999.');
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TransferParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
