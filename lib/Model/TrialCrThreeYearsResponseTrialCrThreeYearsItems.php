...
/**
 * TrialCrThreeYearsResponseTrialCrThreeYearsItems Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialCrThreeYearsResponseTrialCrThreeYearsItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrThreeYearsResponse_trial_cr_three_years_items';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrThreeYearsResponseTrialCrThreeYearsItems., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrThreeYearsResponseTrialCrThreeYearsItems., must be bigger than or equal to 0.');
        }
