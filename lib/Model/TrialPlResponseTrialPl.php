...
class TrialPlResponseTrialPl implements ModelInterface, ArrayAccess
{
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlResponseTrialPl., must be smaller than or equal to 2147483647.');
        }
        if (($company_id < 1)) {
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlResponseTrialPl., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlResponseTrialPl., must be smaller than or equal to 2147483647.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialPlResponseTrialPl., must be smaller than or equal to 2147483647.');
        }
