 ...
 * @link     https://openapi-generator.tech
 */
class TrialPlResponseTrialPl implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'balances' => '\Freee\Accounting\Model\TrialPlResponseTrialPlBalances[]'
    ];
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlResponseTrialPl., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialPlResponseTrialPlBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialPlResponseTrialPlBalances[] $balances balances
     *
     * @return $this
     */
