...
/**
 * DealsPayments Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DealsPayments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deals_payments';
    ...
    public function setId($id)
    {
        ...
        if (($id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DealsPayments., must be smaller than or equal to 999999999999.');
        }
