...
class TrialPlSegment3TagsResponseTrialPlSegment3Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'balances' => '\Freee\Accounting\Model\TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances[]',
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances[] $balances balances
     *
     * @return self
     */
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling TrialPlSegment3TagsResponseTrialPlSegment3Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling TrialPlSegment3TagsResponseTrialPlSegment3Tags., must be bigger than or equal to 1.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialPlSegment3TagsResponseTrialPlSegment3Tags., must be bigger than or equal to 1.');
        }
