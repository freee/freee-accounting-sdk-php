 ...
 */
class TrialCrSectionsResponseTrialCrSectionsSections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrSectionsResponse_trial_cr_sections_sections';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrSectionsResponseTrialCrSectionsSections., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialCrSectionsResponseTrialCrSectionsSections., must be bigger than or equal to 0.');
        }
