 ...
 */
class TrialBsThreeYearsResponseTrialBsThreeYearsItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsThreeYearsResponseTrialBsThreeYearsItems., must be bigger than or equal to 0.');
        }
