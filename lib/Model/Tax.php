...
class Tax implements ModelInterface, ArrayAccess
{
    ...
    public function setCode($code)
    {
        ...
        if (($code > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $code when calling Tax., must be smaller than or equal to 2147483647.');
        }
        if (($code < 1)) {
            throw new \InvalidArgumentException('invalid value for $code when calling Tax., must be bigger than or equal to 1.');
        }
