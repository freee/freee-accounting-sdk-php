...
/**
 * AccountItemParamsAccountItemPartners Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountItemParamsAccountItemPartners implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'accountItemParams_account_item_partners';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $id when calling AccountItemParamsAccountItemPartners., must be smaller than or equal to 999999999999.');
        }
