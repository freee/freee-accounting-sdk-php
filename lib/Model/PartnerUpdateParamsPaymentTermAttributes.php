...
/**
 * PartnerUpdateParamsPaymentTermAttributes Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class PartnerUpdateParamsPaymentTermAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'partnerUpdateParams_payment_term_attributes';
    ...
    public function setCutoffDay($cutoff_day)
    {
        ...
        if (!is_null($cutoff_day) && ($cutoff_day > 32)) {
            throw new \InvalidArgumentException('invalid value for $cutoff_day when calling PartnerUpdateParamsPaymentTermAttributes., must be smaller than or equal to 32.');
        }
        if (!is_null($cutoff_day) && ($cutoff_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $cutoff_day when calling PartnerUpdateParamsPaymentTermAttributes., must be bigger than or equal to 1.');
        }
    ...
    public function setAdditionalMonths($additional_months)
    {
        ...
        if (!is_null($additional_months) && ($additional_months > 6)) {
            throw new \InvalidArgumentException('invalid value for $additional_months when calling PartnerUpdateParamsPaymentTermAttributes., must be smaller than or equal to 6.');
        }
        if (!is_null($additional_months) && ($additional_months < 1)) {
            throw new \InvalidArgumentException('invalid value for $additional_months when calling PartnerUpdateParamsPaymentTermAttributes., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedDay($fixed_day)
    {
        ...
        if (!is_null($fixed_day) && ($fixed_day > 32)) {
            throw new \InvalidArgumentException('invalid value for $fixed_day when calling PartnerUpdateParamsPaymentTermAttributes., must be smaller than or equal to 32.');
        }
        if (!is_null($fixed_day) && ($fixed_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_day when calling PartnerUpdateParamsPaymentTermAttributes., must be bigger than or equal to 1.');
        }
