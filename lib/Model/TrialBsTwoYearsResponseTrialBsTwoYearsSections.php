...
/**
 * TrialBsTwoYearsResponseTrialBsTwoYearsSections Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialBsTwoYearsResponseTrialBsTwoYearsSections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialBsTwoYearsResponse_trial_bs_two_years_sections';
    ...
    public function setId($id)
    {
        ...
        if (($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsTwoYearsResponseTrialBsTwoYearsSections., must be smaller than or equal to 2147483647.');
        }
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsTwoYearsResponseTrialBsTwoYearsSections., must be bigger than or equal to 0.');
        }
