...
/**
 * ExpenseApplicationUpdateParamsExpenseApplicationLines1 Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseApplicationUpdateParamsExpenseApplicationLines1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expenseApplicationUpdateParams_expense_application_lines_1';
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be smaller than or equal to 250.');
        }
    ...
    public function setExpenseApplicationLineTemplateId($expense_application_line_template_id)
    {
        ...
        if (!is_null($expense_application_line_template_id) && ($expense_application_line_template_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $expense_application_line_template_id when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($expense_application_line_template_id) && ($expense_application_line_template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $expense_application_line_template_id when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param int|null $id 経費申請の明細行ID: 既存明細行を更新する場合に指定します。IDを指定しない明細行は、新規行として扱われ追加されます。また、expense_application_linesに含まれない既存の明細行は削除されます。更新後も残したい行は、必ず経費申請の明細行IDを指定してexpense_application_linesに含めてください。
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($id) && ($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationUpdateParamsExpenseApplicationLines1., must be bigger than or equal to 1.');
        }
