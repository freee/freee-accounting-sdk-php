...
/**
 * CreateWalletTxnParams Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateWalletTxnParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createWalletTxnParams';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['walletable_id'] > 999999999999)) {
            $invalidProperties[] = "invalid value for 'walletable_id', must be smaller than or equal to 999999999999.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateWalletTxnParams., must be smaller than or equal to 999999999999.');
        }
        if (($amount < -999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateWalletTxnParams., must be bigger than or equal to -999999999999.');
        }
    ...
    public function setWalletableId($walletable_id)
    {
        ...
        if (($walletable_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $walletable_id when calling CreateWalletTxnParams., must be smaller than or equal to 999999999999.');
        }
        if (($walletable_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $walletable_id when calling CreateWalletTxnParams., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling CreateWalletTxnParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling CreateWalletTxnParams., must be bigger than or equal to 1.');
        }
