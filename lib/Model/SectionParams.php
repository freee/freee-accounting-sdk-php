 ...
 * @link     https://openapi-generator.tech
 */
class SectionParams implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['parent_id']) && ($this->container['parent_id'] > 999999999999)) {
            $invalidProperties[] = "invalid value for 'parent_id', must be smaller than or equal to 999999999999.";
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling SectionParams., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && ($parent_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $parent_id when calling SectionParams., must be smaller than or equal to 999999999999.');
        }
