 ...
 * @link     https://openapi-generator.tech
 */
class ApprovalRequestResponseApprovalRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['approval_flow_logs'] = isset($data['approval_flow_logs']) ? $data['approval_flow_logs'] : null;
        $this->container['approval_flow_route_id'] = isset($data['approval_flow_route_id']) ? $data['approval_flow_route_id'] : null;
        $this->container['approval_request_form'] = isset($data['approval_request_form']) ? $data['approval_request_form'] : null;
        $this->container['approvers'] = isset($data['approvers']) ? $data['approvers'] : null;
        $this->container['comments'] = isset($data['comments']) ? $data['comments'] : null;
        $this->container['company_id'] = isset($data['company_id']) ? $data['company_id'] : null;
        $this->container['current_round'] = isset($data['current_round']) ? $data['current_round'] : null;
        $this->container['current_step_id'] = isset($data['current_step_id']) ? $data['current_step_id'] : null;
