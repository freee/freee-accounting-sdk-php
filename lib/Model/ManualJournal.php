...
class ManualJournal implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['txn_number'] = isset($data['txn_number']) ? $data['txn_number'] : null;
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling ManualJournal., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
