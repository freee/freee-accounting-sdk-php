...
/**
 * TrialPlTwoYearsResponseTrialPlTwoYears Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TrialPlTwoYearsResponseTrialPlTwoYears implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialPlTwoYearsResponse_trial_pl_two_years';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'balances' => '\Freee\Accounting\Model\TrialPlTwoYearsResponseTrialPlTwoYearsBalances[]'
    ];
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlTwoYearsResponseTrialPlTwoYears., must be smaller than or equal to 999999999999.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling TrialPlTwoYearsResponseTrialPlTwoYears., must be bigger than or equal to 1.');
        }
     ...
     * Gets balances
     *
     * @return \Freee\Accounting\Model\TrialPlTwoYearsResponseTrialPlTwoYearsBalances[]
     */
     ...
     * Sets balances
     *
     * @param \Freee\Accounting\Model\TrialPlTwoYearsResponseTrialPlTwoYearsBalances[] $balances balances
     *
     * @return $this
     */
