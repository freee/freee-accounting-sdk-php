...
/**
 * UpdateCompanyParamsAddressAttributes Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class UpdateCompanyParamsAddressAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCompanyParams_address_attributes';
    ...
    public function setPrefectureCode($prefecture_code)
    {
        ...
        if (!is_null($prefecture_code) && ($prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $prefecture_code when calling UpdateCompanyParamsAddressAttributes., must be smaller than or equal to 46.');
        }
        if (!is_null($prefecture_code) && ($prefecture_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $prefecture_code when calling UpdateCompanyParamsAddressAttributes., must be bigger than or equal to 0.');
        }
