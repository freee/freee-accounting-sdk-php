...
class TrialPlSectionsResponseTrialPlSectionsBalances implements ModelInterface, ArrayAccess
{
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialPlSectionsResponseTrialPlSectionsBalances., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialPlSectionsResponseTrialPlSectionsBalances., must be bigger than or equal to 1.');
        }
     ...
     * Sets sections
     *
     * @param \Freee\Accounting\Model\TrialPlSectionsResponseTrialPlSectionsSections[]|null $sections 部門
     *
     * @return $this
     */
