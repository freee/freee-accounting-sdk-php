...
/**
 * TrialCrTwoYearsResponseTrialCrTwoYearsBalances Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialCrTwoYearsResponseTrialCrTwoYearsBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrTwoYearsResponse_trial_cr_two_years_balances';
    ...
    protected static $openAPITypes = [
        ...
        'closing_balance' => 'int',
        'hierarchy_level' => 'int',
        'items' => '\Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsItems[]',
        'last_year_closing_balance' => 'int',
        'parent_account_category_name' => 'string',
        'partners' => '\Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsPartners[]',
        'sections' => '\Freee\Accounting\Model\TrialBsTwoYearsResponseTrialBsTwoYearsSections[]',
        'segment_1_tags' => '\Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags[]',
        'segment_2_tags' => '\Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment2Tags[]',
        'segment_3_tags' => '\Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment3Tags[]',
        'total_line' => 'bool',
        'year_on_year' => 'float'
    ];
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialCrTwoYearsResponseTrialCrTwoYearsBalances., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialCrTwoYearsResponseTrialCrTwoYearsBalances., must be bigger than or equal to 1.');
        }
     ...
     * Gets items
     *
     * @return \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsItems[]|null
     */
     ...
     * Sets items
     *
     * @param \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsItems[]|null $items breakdown_display_type:item, account_item_display_type:account_item指定時のみ含まれる
     *
     * @return self
     */
     ...
     * Gets partners
     *
     * @return \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsPartners[]|null
     */
     ...
     * Sets partners
     *
     * @param \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsPartners[]|null $partners breakdown_display_type:partner, account_item_display_type:account_item指定時のみ含まれる
     *
     * @return self
     */
     ...
     * Gets segment_1_tags
     *
     * @return \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags[]|null
     */
     ...
     * Sets segment_1_tags
     *
     * @param \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags[]|null $segment_1_tags breakdown_display_type:segment_1_tag, account_item_display_type:account_item指定時のみ含まれる
     *
     * @return self
     */
     ...
     * Gets segment_2_tags
     *
     * @return \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment2Tags[]|null
     */
     ...
     * Sets segment_2_tags
     *
     * @param \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment2Tags[]|null $segment_2_tags breakdown_display_type:segment_2_tag, account_item_display_type:account_item指定時のみ含まれる
     *
     * @return self
     */
     ...
     * Gets segment_3_tags
     *
     * @return \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment3Tags[]|null
     */
     ...
     * Sets segment_3_tags
     *
     * @param \Freee\Accounting\Model\TrialCrTwoYearsResponseTrialCrTwoYearsSegment3Tags[]|null $segment_3_tags breakdown_display_type:segment_3_tag, account_item_display_type:account_item指定時のみ含まれる
     *
     * @return self
     */
