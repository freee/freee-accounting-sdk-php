...
/**
 * TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances Class Doc Comment
 *
 * @category Class
 * @package  Freee\Accounting
 * @author   OpenAPI Generator team
 ...
 */
class TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trialCrSegment_3TagsResponse_trial_cr_segment_3_tags_balances';
    ...
    protected static $openAPITypes = [
        ...
        'segment_3_tags' => '\Freee\Accounting\Model\TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags[]',
        'total_line' => 'bool'
    ];
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances., must be bigger than or equal to 1.');
        }
     ...
     * Gets segment_3_tags
     *
     * @return \Freee\Accounting\Model\TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags[]|null
     */
     ...
     * Sets segment_3_tags
     *
     * @param \Freee\Accounting\Model\TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags[]|null $segment_3_tags セグメント3タグ
     *
     * @return self
     */
