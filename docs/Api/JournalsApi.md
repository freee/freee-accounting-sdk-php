...
try {
    $apiInstance->downloadJournal($id, $company_id);
} catch (Exception $e) {
...
> \Freee\Accounting\Model\JournalsStatusResponse getJournalStatus($company_id, $id, $visible_tags, $start_date, $end_date)
...
[**\Freee\Accounting\Model\JournalsStatusResponse**](../Model/JournalsStatusResponse.md)
...
> \Freee\Accounting\Model\JournalsEnqueueJournalsResponse getJournals($download_type, $company_id, $visible_tags, $start_date, $end_date)
...
[**\Freee\Accounting\Model\JournalsEnqueueJournalsResponse**](../Model/JournalsEnqueueJournalsResponse.md)
